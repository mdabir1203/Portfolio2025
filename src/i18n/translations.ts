...
export const translations = {
  en: {
    ...
    spoken: {
      tag: '// Spoken · 4 languages',
      heading: 'Multilingual across the GCC + South Asia.',
      sub: 'Native Bengali, fluent English, working German — Hindi spoken conversationally across the South Asian diaspora that powers GCC operations.',
      langs: [
        {
          code: 'EN',
          flag: '🇬🇧',
        ...
        },
        {
          ...
          english: 'German',
          proficiency: 'Working',
          detail: 'Goethe A2 · 42 Wolfsburg era',
        },
        {
          code: 'HI',
          flag: '🇮🇳',
          ...
          detail: 'South Asia + UAE diaspora lingua',
        },
      ],
    },
    gcc: {
      tag: '// GCC · open to work',
      heading: 'Five GCC markets, one operating cadence.',
      sub: 'Cross-cultural GTM delivery — founders, SMEs and enterprises across the Gulf.',
      markets: [
        {
          flag: '🇦🇪',
          country: 'UAE',
          ...
          status: 'Home',
          statusTone: 'lime',
          note: 'UAE Company Visa held',
        },
        {
          flag: '🇸🇦',
          country: 'KSA',
          cities: 'Riyadh · NEOM · Jeddah',
          status: 'Open',
          statusTone: 'teal',
          note: 'Vision 2030 programs',
        },
        {
          flag: '🇶🇦',
          country: 'Qatar',
  ...
  ar: {
    ...
    spoken: {
      tag: '// اللغات · 4 لغات',
      heading: 'متعدد اللغات عبر الخليج وجنوب آسيا.',
      sub: 'لغة الأم بنغالية، الإنجليزية بطلاقة، الألمانية بمستوى عمل — الهندية محادثات عبر شتات جنوب آسيا الذي يدير عمليات الخليج.',
      langs: [
        {
          code: 'EN',
          flag: '🇬🇧',
        ...
        },
        {
          ...
          native: 'Deutsch',
          english: 'الألمانية',
          proficiency: 'مستوى عمل',
          detail: 'Goethe A2 · عصر 42 Wolfsburg',
        },
        {
          code: 'HI',
          flag: '🇮🇳',
          ...
          english: 'الهندية',
          proficiency: 'محادثات',
          detail: 'لغة شتات جنوب آسيا والإمارات',
        },
      ],
    },
    gcc: {
      tag: '// الخليج · متاح للعمل',
      heading: 'خمس أسواق خليجية، إيقاع تشغيل واحد.',
      sub: 'الذهاب للسوق عبر الثقافات — المؤسسون والشركات الصغيرة والمتوسطة والمؤسسات في الخليج.',
      markets: [
        {
          flag: '🇦🇪',
          country: 'الإمارات',
          ...
          status: 'الوطن',
          statusTone: 'lime',
          note: 'تأشيرة شركة إماراتية',
        },
        {
          flag: '🇸🇦',
          country: 'السعودية',
          cities: 'الرياض · نيوم · جدة',
          status: 'متاح',
          statusTone: 'teal',
          note: 'برامج رؤية 2030',
        },
        {
          flag: '🇶🇦',
          country: 'قطر',
          ...
          status: 'متاح',
          statusTone: 'teal',
          note: 'توافق مع رؤية قطر 2030',
        },
        {
          flag: '🇧🇭',
          country: 'البحرين',
          cities: 'المنامة · الرفاع',
          status: 'متاح',
          statusTone: 'teal',
          note: 'التكنولوجيا المالية وعمليات الخليج',
        },
        {
          flag: '🇴🇲',
          country: 'عمان',
