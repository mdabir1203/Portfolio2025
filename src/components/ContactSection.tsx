  ...
  <section className="mb-12 sm:mb-16 animate-fadeIn">
    ...
    <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 px-4 sm:px-0">
      ...
      <div className="bg-[#052c28]/70 border border-[#2f6f68]/40 rounded-xl p-5 sm:p-6 md:p-8 hover:-translate-y-1 transition-all duration-300 hover:shadow-[0_26px_60px_rgba(0,150,136,0.22)]">
        ...
        <div>
          <h4 className="text-lg font-semibold text-[#c8fff4] mb-4">Machine Readable Data</h4>
          <a
            href="/data.json"
            download
            className="w-full flex items-center justify-center gap-2 bg-[#033832]/60 border border-[#2f6f68]/40 text-[#a7ffeb] font-semibold tracking-wide py-3 px-6 rounded-lg hover:border-[#00bfa5] hover:bg-[#02423b]/70 transition-all duration-300 shadow-[0_16px_35px_rgba(0,150,136,0.15)] hover:-translate-y-0.5"
          >
