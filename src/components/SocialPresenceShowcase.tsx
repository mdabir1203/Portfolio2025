            ...
            <div className="relative">
              ...
              >
                ...
                <desc id={chartDescId}>
                  ...
                  {` ${followerSegments[2].value}`} followers contributing to a {totalLabel} human-first advocacy network.
                </desc>
                <defs>
                  <radialGradient id={haloId} cx="50%" cy="50%" r="50%">
                    <stop offset="55%" stopColor="#0EF9D7" stopOpacity="0" />
                    <stop offset="100%" stopColor="#0EF9D7" stopOpacity="0.32" />
                  </radialGradient>
                </defs>
                <circle cx="120" cy="120" r={radius + strokeWidth} fill={`url(#${haloId})`} opacity="0.45" />
                <circle cx="120" cy="120" r={radius} fill="none" stroke="#0F3D37" strokeWidth={strokeWidth} />
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                <span className="text-[0.7rem] uppercase tracking-[0.34em] text-[#c1fff4]">Network</span>
                <span className="text-4xl font-semibold text-[#f5fff9]">{totalLabel}</span>
                <span className="text-[0.7rem] uppercase tracking-[0.24em] text-[#cfffed]">
